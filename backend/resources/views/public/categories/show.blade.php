...
@section('meta_description', $category->description ?: ('Artikel kategori '.$category->name))
...
@section('content')
    <div class="rounded-3xl border border-gray-200 bg-gradient-to-br from-brand-50 via-white to-white p-6 shadow-sm sm:p-10">
        ...
        <h1 class="mt-4 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl">{{ $category->name }}</h1>
