<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            ...
            <a class="inline-flex items-center rounded-md bg-gray-900 px-4 py-2 text-sm font-semibold text-white hover:bg-black" href="{{ route('admin.tags.create') }}">Tambah</a>
        </div>
    </x-slot>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @foreach ($tags as $tag)
                                    <tr>
                                        <td class="py-3 pr-4 font-semibold text-gray-900">{{ $tag->name }}</td>
                                        <td class="py-3 pr-4 text-gray-700">{{ $tag->slug }}</td>
